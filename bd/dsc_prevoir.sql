...
CREATE TABLE `prevoir` (
  ...
  PRIMARY KEY (`SINISTRE_id`,`TYPE_ENGIN_id`),
  KEY `TYPE_ENGIN_id` (`TYPE_ENGIN_id`),
  CONSTRAINT `prevoir_ibfk_1` FOREIGN KEY (`SINISTRE_id`) REFERENCES `sinistre` (`id`),
  CONSTRAINT `prevoir_ibfk_2` FOREIGN KEY (`TYPE_ENGIN_id`) REFERENCES `type_engin` (`id`)
...
INSERT INTO `prevoir` VALUES (1,'EPA');
