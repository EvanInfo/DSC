    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
        <ul class="navbar-nav ">
            <li class="nav-item text-center  ">
                    <a class="nav-link" data-toggle="" href="../pages/Accueil.php">
            ...
            <li class="nav-item text-center ml-3  ">
                <a class="nav-link" data-toggle="" href="../pages/vehicule.php">
            ...
            <li class="nav-item text-center ml-3">
                <a class="nav-link" data-toggle="" href="../pages/formulaire.php">
