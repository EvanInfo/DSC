...
CREATE TABLE `exercer` (
  ...
  CONSTRAINT `exercer_ibfk_1` FOREIGN KEY (`Matricule`) REFERENCES `pompier` (`Matricule`),
  CONSTRAINT `exercer_ibfk_2` FOREIGN KEY (`HABILITATION_id`) REFERENCES `habilitation` (`id`)
...
INSERT INTO `exercer` VALUES (782312,3,'2019-10-12'),(986995,1,'1980-12-03'),(986995,2,'1982-08-12'),(992312,4,'2020-10-16');
