        ...
        <ul class="navbar-nav ">
            ...
            <?php if (isset($_SESSION['login']) && $_SESSION['login'] == true): ?>
                <li class="nav-item text-center ml-3">
                    <a class="nav-link <?php if ($nomFichier==="lesVehicules.php" || $nomFichier === "vehicule.php" || $nomFichier === "ajout_Vehicule.php" || $nomFichier === "modification_Engin.php" || $nomFichier === "suppression_Engin.php" || $nomFichier === "gestionVehicule.php" || $nomFichier === "ajoutVehiculeCaserne.php" || $nomFichier === "suppressionVehiculeCaserne.php") { echo 'text-dark'; } else {echo 'text-white';}?>" data-toggle="" href="../pages/lesVehicules.php">
                ...
                <li class="nav-item text-center ml-3">
                    <a class="nav-link <?php if ($nomFichier==="pompier.php") { echo 'text-dark'; } else {echo 'text-white';}?>" href="../pages/pompier.php">
